...
import ToggleButton from "../../ToggleButton"; // plasmic-import: MOo2ZKYCDwqpy/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_todo_mvc.module.css"; // plasmic-import: 5mf52pddX4JykqxN3idS7N/projectcss
import sty from "./PlasmicFooter.module.css"; // plasmic-import: aIVrGH9qBMI5z/css
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ppTjO, {
            [sty.freeBoxstate_empty__ppTjOhHbIt]: hasVariant(
              variants,
              "state",
              "empty"
            ),
            [sty.freeBoxstate_hasCompleted__ppTjOu7EXg]: hasVariant(
              variants,
              "state",
              "hasCompleted"
            ),
            [sty.freeBoxstate_singularLeft__ppTjOxlGym]: hasVariant(
              variants,
              "state",
              "singularLeft"
            )
          ...
          {(hasVariant(variants, "state", "singularLeft") ? true : true) ? (
            <div
              className={classNames(
                ...
                sty.text__h2M2,
                {
                  [sty.textstate_empty__h2M2HHbIt]: hasVariant(
                    variants,
                    "state",
                    "empty"
                  ),
                  [sty.textstate_hasCompleted__h2M2U7EXg]: hasVariant(
                    variants,
                    "state",
                    "hasCompleted"
                  ),
                  [sty.textstate_singularLeft__h2M2XlGym]: hasVariant(
                    variants,
                    "state",
                    "singularLeft"
                  )
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vzYeF)}
      >
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__u3KW)}
        ...
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__eNeuR)}
        >
          {"Completed"}
        </ToggleButton>

        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton___1OS3)}
        >
          {"Active"}
        </ToggleButton>
      </p.Stack>
      ...
      {(hasVariant(variants, "state", "hasCompleted") ? true : false) ? (
        <div
          className={classNames(
            ...
            sty.text__fjzKc,
            {
              [sty.textstate_hasCompleted__fjzKcU7EXg]: hasVariant(
                variants,
                "state",
                "hasCompleted"
              )
